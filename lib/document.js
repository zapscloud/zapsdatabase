...
module.exports = class Document {
    ...
    updateMany(collectionname, filterquery, jsondata, transactionid) {
        return new Promise((resolve, reject) => {
            ...
            axios.put(`https://database.api${this.stage}.zapscloud.com/documents/${collectionname}${encodeURI(queryparam)}`, jsondata, this.header_param)
                .then(function (response) {
                    return resolve(response.data);
                })
                .catch(function (error) {
    ...
    deleteMany(collectionname, filterquery, transactionid) {
        return new Promise((resolve, reject) => {
            ...
            axios.delete(`https://database.api${this.stage}.zapscloud.com/documents/${collectionname}${encodeURI(queryparam)}`, this.header_param)
                .then(function (response) {
                    return resolve(response.data);
                })
                .catch(function (error) {
    ...
    findOne(collectionname, filterquery, lookupkeys) {
        return new Promise((resolve, reject) => {
            var queryparam = (filterquery ? `?filter=${filterquery}` : '');
            queryparam = (lookupkeys ? (queryparam!=''?`${queryparam}&`:'?')+`lookup=${lookupkeys}` : queryparam);

            debug('Fine Keys ',queryparam)
            debug('URL & Header values ', `https://database.api${this.stage}.zapscloud.com/documents/${collectionname}/findone${queryparam}`, this.header_param)
            axios.get(`https://database.api${this.stage}.zapscloud.com/documents/${collectionname}/findone${queryparam}`, this.header_param)
                .then(function (response) {
                    return resolve(response.data);
                })
                .catch(function (error) {
    ...
    getMany(collectionname, filterquery, sortquery, skip, limit) {
        return new Promise((resolve, reject) => {
            ...
            debug('Filter Query ', queryparam, `https://database.api${this.stage}.zapscloud.com/documents/${collectionname}${encodeURI(queryparam)}`)
            axios.get(`https://database.api${this.stage}.zapscloud.com/documents/${collectionname}${encodeURI(queryparam)}`, this.header_param)
                .then(function (response) {
                    return resolve(response.data);
                })
                .catch(function (error) {
